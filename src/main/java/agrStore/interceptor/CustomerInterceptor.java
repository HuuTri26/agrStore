 ...
 * HttpServletResponse response, Object handler) throws Exception { String uri =
 * request.getRequestURI(); // System.out.println(uri); // Không kiểm tra khi
 * truy cập đến các trang sau if ( uri.contains("index.htm") ||
 * uri.contains("userLogin.htm") || uri.contains("userSignUp.htm") ||
 ...
 * uri.contains("userForgotPasswordGmail.htm")) { return true; } AccountEntity
 * loggedInUser = (AccountEntity)
