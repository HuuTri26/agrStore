...
public class StaffAccountController {
	...
	public String staffProfile(HttpServletRequest request, @RequestParam(value = "provinceId", required = false) Integer provinceId,
	...
	// 
	@RequestMapping(value = "/staffProfile", params = "save", method = RequestMethod.POST)
	...
	public String staffChangePassword(HttpServletRequest request, HttpSession session,
		...
		System.out.println("==> Open an staff change password session");
		return "staff/account/staffChangePassword";
	}
	
	@RequestMapping(value = "/staffChangePassword", method = RequestMethod.POST)
	public String staffShowChangePassword(HttpServletRequest request, @ModelAttribute("changePass") AccountEntity changePass,
		...
		if (isValidPass) {
			try {
				...
				accountService.updateAccount(loggedInUser);
				System.out.println("==> staff account password updated successfully!");
			} catch (Exception e) {
				System.out.println("Error: staff account password updated unsuccessfully!");
			}
		} else {
			System.out.println("Error: staff account password updated unsuccessfully!");
			 return "staff/account/staffChangePassword";
