										...
										<div
											...
											<div class="row gx-3">
												...
												<div class="col-xxl-4 col-sm-6 col-12">
													<!-- Form Field Start -->
													<div class="mb-3">
														<label for="phoneNo" class="form-label">SĐT</label> <input
															type="text" class="form-control"
												...
												<div class="col-xxl-4 col-sm-6 col-12">
													...
													<div class="mb-3">
														<label for="phoneNo" class="form-label">Tỉnh</label> <input
															type="text" class="form-control" value="TP HCM" readonly>
													</div>
												</div>
												<div class="col-xxl-4 col-sm-6 col-12">
													<!-- Form Field Start -->
													...
													<div class="mb-3">
														<label for="phoneNo" class="form-label">Huyện</label> <input
															type="text" class="form-control" value="Quận 9" readonly>
													</div>
												</div>
												<div class="col-xxl-4 col-sm-6 col-12">
													<!-- Form Field Start -->
													...
													<div class="mb-3">
														<label for="phoneNo" class="form-label">Xã</label> <input
															type="text" class="form-control" value="Hiệp Phú"
															readonly>
													</div>
												</div>
												<div class="col-xxl-8 col-sm-12 col-12">
													<!-- Form Field Start -->
													<div class="mb-3">
														<label for="address" class="form-label">Đại chỉ</label> <input
															type="text" class="form-control" id="address"
															value="97 Man Thiện" readonly>
													</div>
												</div>
