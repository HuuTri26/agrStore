								...
								<div class="card-header">
									<c:choose>
										...
										<c:when test="${mode == 'VIEW'}">
											...
											<div class="card-title">VIEW PROVIDER</div>
										...
										<c:when test="${mode == 'EDIT'}">
											...
											<div class="card-title">EDIT PROVIDER</div>
											<!-- Populate dữ liệu vào form -->
											<%-- <input type="text" class="form-control"
												value="${category.name}"> --%>
										</c:when>
										<c:when test="${mode == 'DELETE'}">
											<div class="card-title">DELETE PROVIDER</div>
										</c:when>
									</c:choose>
								</div>
								<div class="card-body">
									...
									<div class="row gx-3">
										<div class="col-sm-6 col-12">
											<div class="card-border">
												<div class="card-border-title">Provider Images</div>
										...
										<form
											action="${pageContext.request.contextPath}/providerManagement/provider.htm"
											method="post">
											<div class="col-sm-6 col-12">
												<div class="card-border">
													<div class="card-border-title">Provider</div>
													<div class="card-border-body">
															...
															<div class="col-sm-6 col-12">
																<div class="mb-3">
																	<label class="form-label">Provider Name <span
																		...
																		class="form-control" name="providerName"
																		placeholder="" value="${provider.providerName}">
																</div>
															</div>
															<div class="col-sm-6 col-12">
																<div class="mb-3">
																	<label class="form-label">Provider PhoneNumber
																		<span class="text-red">*</span>
																	</label> <input type="text" class="form-control"
																		name="phoneNumber" placeholder="" value="${provider.phoneNumber}">
																</div>
															</div>
